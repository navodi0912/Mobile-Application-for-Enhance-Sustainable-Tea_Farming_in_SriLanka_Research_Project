...
class FertilizerAnalysisPage extends StatefulWidget {
  const FertilizerAnalysisPage({super.key});

  @override
  _FertilizerAnalysisPageState createState() => _FertilizerAnalysisPageState();
}

class _FertilizerAnalysisPageState extends State<FertilizerAnalysisPage> {
  ...
  Future<void> _fetchPredictions() async {
    List<Map<String, dynamic>> predictions =
        await _firestoreService.getFertilizerPredictions();
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:
            Text(AppLocalizations.of(context)!.translate('fertilizerAnalysis')),
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text(
              AppLocalizations.of(context)!.translate('fertilizerCount'),
              style: TextStyle(
                fontSize: 24,
