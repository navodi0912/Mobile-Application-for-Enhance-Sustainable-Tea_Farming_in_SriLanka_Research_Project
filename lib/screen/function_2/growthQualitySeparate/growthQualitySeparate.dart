...
import 'package:harvest_pro/screen/function_2/growthQualitySeparate/components/imagebox.dart';
import 'package:harvest_pro/screen/function_2/growthQualitySeparate/components/leafcapture.dart';
...
class GrowthQualitySeparate extends StatefulWidget {
  const GrowthQualitySeparate({super.key});

  @override
  _GrowthQualitySeparateState createState() => _GrowthQualitySeparateState();
}

class _GrowthQualitySeparateState extends State<GrowthQualitySeparate> {
...
//
  ...
  void _processResult(Map<String, dynamic> result) async {
    ...
    if (result.containsKey('error')) {
      ...
      recommendationGrowthList = _getRecommendationsForQuality(growthClass);
      ...
      Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/growth2.png'),
            fit: BoxFit.cover,
          ),
        ),
      ),
